...
def plot_das_bi(data, probabilities, window_duration=6, overlap_duration=1.2, threshold=0.9, fsamp=100, channel_idx=0):
    ...
    fig, axs = plt.subplots(2, 2, figsize=(12, 6),
                             gridspec_kw={'height_ratios': [5, 1], 'wspace': 0.05, 'hspace': 0},
    ...
    # Color bar for normalized strain rate
    cbar = fig.colorbar(axs[0, 0].images[0], ax=axs[:, :].ravel().tolist(), orientation='vertical', fraction=0.02, pad=0.02, extend='both')
